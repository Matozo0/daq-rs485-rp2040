...
#define RX_PIN1 16
#define TX_PIN1 17
#define DE_RE_PIN1 18
#define BAUD_RATE1 19200

#define RX_PIN2 15
#define TX_PIN2 14
#define DE_RE_PIN2 13
#define BAUD_RATE2 1000000

SerialPIO SerialRS4851(NOPIN, RX_PIN1, 256);
SerialPIO SerialRS4852(NOPIN, RX_PIN2, 1024);

const uint8_t commandModbus[] = {0x05, 0x03, 0x00, 0x00, 0x00, 0x0A, 0xC4, 0x49};
unsigned long lastMillis;

uint8_t rxBuffer1[25];
int rxIndex1 = 0;
double valuesStrain[5];
unsigned long lastFreqTime1 = 0;
int packetCounter1 = 0;
float hzStrain = 0.0;

uint8_t rxBuffer2[15];
int rxIndex2 = 0;
int16_t valuesAccel[7];
